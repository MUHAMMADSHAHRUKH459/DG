...
const products = [
  { name: "Black Hoodie", image: "/images/mug1.png", price: 1800, rating: 4, description: "Comfortable and stylish hoodie for everyday wear." },
  { name: "Black Top", image: "/images/mug1.png", price: 1800, rating: 4, description: "Simple yet elegant black top for any occasion." },
  { name: "Drop T-Shirt", image: "/images/mug1.png", price: 1800, rating: 4, description: "Casual drop t-shirt with a modern twist." },
  { name: "Classic Jacket", image: "/images/mug1.png", price: 2500, rating: 5, description: "A timeless classic jacket perfect for cooler weather." },
  { name: "Sporty Hoodie", image: "/images/mug1.png", price: 2200, rating: 4, description: "Sporty hoodie for all your fitness and casual needs." },
  { name: "Trendy T-Shirt", image: "/images/mug1.png", price: 1600, rating: 4, description: "Trendy and stylish t-shirt for a fashionable look." },
];
