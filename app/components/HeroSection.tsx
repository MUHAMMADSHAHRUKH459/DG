...
const HeroSection = () => {
  ...
  return (
    <>
      <Head >
        ...
        <link href="https://fonts.googleapis.com/css2?family=Creepster&family=Fjalla+One&display=swap" rel="stylesheet" />
      </Head>
        ...
        <div className="container mx-auto px-6 py-16 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 mt-[-40px]">
          ...
          <div className="flex-1 space-y-6 max-w-lg text-center lg:text-left">
            ...
            >
              ...
              {/* Circular Image */}
              <div className="w-40 h-40 ml-6 overflow-hidden rounded-tr-[31px] hidden md:block">
  ...
  alt="Hero Image"
  className="w-auto h-auto mt-11 md:w-96 md:h-screen lg:w-[700px] lg:h-[700px] object-cover rounded-lg relative z-10"
